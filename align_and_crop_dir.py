...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_dir', default=r'E:\ZeroOne\data\CelebA_HQ_512\train\female',type=str, help='source directory containing images to crop and align.')
    parser.add_argument('--results_dir', default=r'E:\ZeroOne\data\CelebA_HQ_512_align\train\female', type=str, help='results directory to save the aligned faces.')
