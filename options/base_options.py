...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # parser.add_argument('--dataroot', default='E:/LiuJia/Privacynet_D_FM/gender-an/results/4atts/100W/Gender', help='path to images')
        parser.add_argument('--dataroot', default='E:/LiuJia/CelebA_HQ/Valid', help='path to images')
        parser.add_argument('--name', type=str, default='FSRN_CelebA', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./check_points/FSRN_Black_E/white', help='models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='enhance', help='chooses which model to train [parse|enhance]')
        parser.add_argument('--input_nc', type=int, default=3, help='# of input image channels: 3 for RGB and 1 for grayscale')
        parser.add_argument('--Dinput_nc', type=int, default=22, help='# of input image channels: 3 for RGB and 1 for grayscale')
        ...
        # dataset parameters
        parser.add_argument('--dataset_name', type=str, default='celeba', help='dataset name [single | celebahqmask | ffhq | celeba]')
        parser.add_argument('--selected_attrs', type=list, default=['Male'])
        parser.add_argument('--Pimg_size', type=int, default='224', help='image size for face parse net')
        parser.add_argument('--Gin_size', type=int, default='224', help='image size for face parse net')
        parser.add_argument('--Gout_size', type=int, default='224', help='image size for face parse net')
